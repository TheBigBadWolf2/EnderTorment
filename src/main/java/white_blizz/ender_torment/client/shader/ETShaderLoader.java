...
public class ETShaderLoader {
   ...
   public static ETShaderLoader func_216534_a(ShaderType p_216534_0_, String p_216534_1_, InputStream p_216534_2_) throws IOException {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      ...
      if (s == null) {
         ...
         if (GlStateManager.getShader(i, 35713) == 0) {
            ...
            ETShaderLoader shaderloader = new ETShaderLoader(p_216534_0_, i, p_216534_1_);
